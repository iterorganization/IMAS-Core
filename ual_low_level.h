...
int endDataobjectGet(int pulseCtx);
...
int endDataobjectPutTimed(int pulseCtx);

int beginDataobjectPutNonTimed(int pulseCtx, const char *path);
int endDataobjectPutNonTimed(int pulseCtx);
...
int beginObject(int ctx, int index, const char *fieldPath, const char *timebasePath, int size);
...
int getObject(int opCtx, const char *fieldPath, const char *timebase, int *size);
int getObjectFromObject(int aosCtx, const char *fieldPath, const char *timebase, int idx, int *size);
...
int getComplexFromObject(int aosCtx, const char *fieldPath, const char *timebase, int idx, Complex *data);
...
int getVect1DComplexFromObject(int aosCtx, const char *fieldPath, const char *timebase, int idx, Complex **data, int *dim);
...
int getVect2DComplexFromObject(int aosCtx, const char *fieldPath, const char *timebase, int idx, Complex **data, int *dim1, int *dim2);
...
int getVect3DComplexFromObject(int aosCtx, const char *fieldPath, const char *timebase, int idx, Complex **data, int *dim1, int *dim2, int *dim3);
...
int getVect4DComplexFromObject(int aosCtx, const char *fieldPath, const char *timebase, int idx, Complex **data, int *dim1, int *dim2, int *dim3, int *dim4);
...
int getVect5DComplexFromObject(int aosCtx, const char *fieldPath, const char *timebase, int idx, Complex **data, int *dim1, int *dim2, int *dim3, int *dim4, int *dim5);
...
int getVect6DComplexFromObject(int aosCtx, const char *fieldPath, const char *timebase, int idx, Complex **data, int *dim1, int *dim2, int *dim3, int *dim4, int *dim5, int *dim6);
...
int putComplexInObject(int aosCtx, const char *fieldPath, const char *timebasePath, int idx, Complex data);
...
int putVect1DComplexInObject(int aosCtx, const char *fieldPath, const char *timebasePath, int idx, Complex *data, int dim);
...
int putVect2DComplexInObject(int aosCtx, const char *fieldPath, const char *timebasePath, int idx, Complex *data, int dim1, int dim2);
...
int putVect3DComplexInObject(int aosCtx, const char *fieldPath, const char *timebasePath, int idx, Complex *data, int dim1, int dim2, int dim3);
...
int putVect4DComplexInObject(int aosCtx, const char *fieldPath, const char *timebasePath, int idx, Complex *data, int dim1, int dim2, int dim3, int dim4);
...
int putVect5DComplexInObject(int aosCtx, const char *fieldPath, const char *timebasePath, int idx, Complex *data, int dim1, int dim2, int dim3, int dim4,int dim5);
...
int putVect6DComplexInObject(int aosCtx, const char *fieldPath, const char *timebasePath, int idx, Complex *data, int dim1, int dim2, int dim3, int dim4,int dim5, int dim6);
...
int putVect7DComplexInObject(int aosCtx, const char *fieldPath, const char *timebasePath, int idx, Complex *data, int dim1, int dim2, int dim3, int dim4,int dim5, int dim6, int dim7);
