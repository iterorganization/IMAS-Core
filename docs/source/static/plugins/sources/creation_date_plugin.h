#ifndef CREATION_DATE_PLUGIN_H
#define CREATION_DATE_PLUGIN_H_H 1
...
class Creation_date_plugin: public access_layer_plugin
{
  public:
    Creation_date_plugin();
    ~Creation_date_plugin();
...
extern "C" access_layer_plugin* create() {
  return new Creation_date_plugin;
}
