...
This page describes how to build and install the IMAS-Core.
...
.. note:: 
    ...
    .. code-block:: text
        ...
        cmake -B build \
            ...
            -D AL_PLUGINS_GIT_REPOSITORY=https://github.com/iterorganization/IMAS-Plugins.git \
...
-   **Dependency configuration options**
    ...
    -   ``AL_CORE_GIT_REPOSITORY``,
        ...
        where the ``IMAS-Core``, ``IMAS-Plugins`` c.q.
    ...
    .. code-block:: text
        ...
        AL_PLUGINS_GIT_REPOSITORY:  git@github.com:iterorganization/IMAS-Plugins.git
