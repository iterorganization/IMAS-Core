...
.. note::
    ...
    your IMAS-Core installation.

You can also run sample program given in tests directory of IMAS-Core (tests/testlowlevel.cpp) to see how to use low level functions.